.text
# O maior número considerado é 999 que tem 10 bits.
# Logo será necessário 9 divisões
# Imprime os restos das divisões e o quociente da última div (bit mais significativo)
main:	
addi $2, $0, 5
syscall
add $8, $2, $0
